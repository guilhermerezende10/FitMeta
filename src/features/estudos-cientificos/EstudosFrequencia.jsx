...
import { estudosFrequencia } from "../../data/data-estudos-cientificos";
...
function EstudosFrequencia() {
  ...
  return (
    ...
    >
      ...
      {/* Conteúdo */}
      <div className="absolute mt-32 w-full flex flex-col items-center z-10 px-4">
        <Title
          className="
...
export default EstudosFrequencia;
